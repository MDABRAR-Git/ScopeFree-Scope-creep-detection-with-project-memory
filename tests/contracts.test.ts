...
const task = { id: "t1", title: "Existing deliverable", classification: "IN_SCOPE", matchedScopeClause: null, sourceEvidence: [], estimatedHours: { minimum: 0, likely: 0, maximum: 0 }, assumptions: [], complexity: "Small", risks: [], missingInformation: [], explanation: "Test-only contract fixture" };
describe("shared strict contracts", () => {
  ...
  it("rejects duplicated IDs, excluded fields and IN_SCOPE work with extra hours", () => {
