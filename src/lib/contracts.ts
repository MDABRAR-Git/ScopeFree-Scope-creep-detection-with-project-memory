...
export const errorCodes = [
  ...
  "BASELINE_REQUIRED", "BASELINE_INVALID", "UNSUPPORTED_FILE", "EXTRACTION_FAILED", "AI_NOT_CONFIGURED", "AI_UNAVAILABLE", "AI_RATE_LIMITED", "AI_TIMEOUT", "AI_OUTPUT_INVALID", "INVALID_ESTIMATE", "UNCERTAIN_TASKS", "STALE_REVISION", "BASELINE_CHANGED", "LINK_EXPIRED", "LINK_REVOKED", "ALREADY_DECIDED", "CONTEXT_TOO_LARGE",
] as const;
