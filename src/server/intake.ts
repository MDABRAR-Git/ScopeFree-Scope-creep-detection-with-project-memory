...
const requestSelect = { id: true, requestNumber: true, summary: true, projectId: true, text: true, hourlyRatePaise: true, basedOnScopeRevision: true, createdAt: true, estimate: { select: { id: true } } } as const;
