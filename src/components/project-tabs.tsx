...
export function ProjectTabs({ projectId }: { projectId: string }) {
  ...
  return <nav className="project-tabs" aria-label="Project sections">
    ...
    <span className="project-tab unavailable" aria-disabled="true" title="Available in Milestone 7"><MessageSquare size={17} aria-hidden="true" />Ask Project Memory <small>Milestone 7</small></span>
  </nav>;
}
